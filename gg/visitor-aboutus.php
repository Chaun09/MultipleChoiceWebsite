        ...
        <div class="about-container" id="about-container">
            <h1 class="about-title">About Us</h1>
                ...
                <div class="about-content">
                    <p>
                    QuizWebsite is a responsive online learning website that aims to enhance student’s learning 
                        quality from different educational backgrounds such as students from the Information Technology course, 
                        Design course, Business course and much more. The main objective of QuizWebsite is to assess students’ knowledge towards a 
                        specific academic domain while having a major goal to spark interest in subjects such as information technology. QuizWebsite also 
                        ...
                        problem solving and critical thinking skills. QuizWebsite, similarly like Kahoot specializes in providing various quizzes for users to answer 
                ...
                <div class="mission-content">
                    ...
                    <p>
                    To make learning awesome! At QuizWebsite!, we are all about lifelong learning. In life, we learn new skills through curiosity and play. 
                ...
                <div class="values-content">
                    ...
                    <div class="values-column-3">
                        ...
                        <div class="val-col-right">
                            ...
                            <p>
                            We’re team players and QuizWebsite strives to ensure that everyone has the chance to succeed.
                            </p>
                        </div>
                    </div>
                </div>
