        ...
        <div class="faq-help" id="faq-help">
            <div class="faq-box">
                <div class="account-setup">
                    ...
                    <h1>Account Setup</h1>
                    <h2>Get started on <br>QuizWebsite</h2>
                    <div class="overlay">
                        <p>Account Setup</p>
                        <div class="questions">
                            <h2><a href="#1">Create a QuizWebsite Account</a></h2>
            ...
            <div class="faq-box">
                <div class="enrollment">
                    ...
                    <h1>Join Quiz</h1>
                    <h2>Join a quiz on <br>QuizWebsite</h2>
                    <div class="overlay">
                        <p>Join Quiz</p>
                        <div class="questions">
            ...
            <div class="faq-content">
                <details id="1">
                    <summary id="faq-question">
                        <span>
                            Create a QuizWebsite Account
                        </span>
                    </summary>
                        <p style="margin-top: 10px; margin-bottom: 10px; font-size: 18px;">Here are the steps to create an account with QuizWebsite</p>
                        <li>1. Login to QuizWebsite from a browser, and click on the sign-up on the top right corner.</li>
                ...
                <details id="2">
                    <summary id="faq-question">
                        ...
                        <li>1. Login to your QuizWebsite account, mouse over to "My Account" and click on "Profile" from the drop down list.</li>
                ...
                <details id="4">
                    <summary id="faq-question">
                        ...
                        <li style="list-style-type: none;">In QuizWebsite, we provide Business, Design, IT and more quizzes for all the students.</li>
                ...
                <details id="7">
                    <summary id="faq-question">
                        ...
                        <li>2. If you have try the steps above but still unable to login at the end. Please drop us an email to 
                            <a style="color: #FA8334" href="mailto: bangcac24@gmail.com">bangcac24@gmail.com</a>
                        </li>
                </details>
                <details id="8">
                    <summary id="faq-question">
                        ...
                        <li style="list-style-type: none;">Please contact us at: <a style="color: #FA8334" href="mailto: bangcac24@gmail.com">bangcac24@gmail.com</a></li>
                </details>
            </div>
        </div>
