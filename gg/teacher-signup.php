                ...
                <p class="registration-title">Start creating your own quiz!</p>
                    <form action="#" method="POST" onsubmit="return validate_form();" enctype="multipart/form-data" id="signup">
                        ...
                        <div class="proof-des">
                            ...
                            <p class="tr-paragraph">To get verified as a teacher on QuizWebsite, the applicant must submit proof of education to prove themselves qualified to create quiz for the students.</p>
