    ...
    <footer>
        ...
        <div class="skillsoft-footer" id="skillsoft-footer">
            <div class="logo-and-social">
                <a class="skillsoft-logo" href="#">Quiz<b>Website.</b></a>
                <p class="company-des">Quiz Website provide multiple features to make a classroom fun, interactive and engaging. Quizzes for everyone in anywhere.</p>
